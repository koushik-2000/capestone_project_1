        ...
        <div className="lefte">
          <div className="banner">
            ...
            <p className="caption">
              {" "}
              Choose your <br />
              entertainment <br /> category
            </p>
          </div>
          <div className="choice">
            {item.map((element, index) => (
              <p key={index} id={element} className="neon">
                {element}{" "}
                <img
                  src={images.cross}
                  alt="x"
        ...
        <div className="right">
          <div className="catImg">
            <div className="catItem action" id="action" onClick={toggle}>
              <h3 className="title" id="action" onClick={toggle}>
                action
              </h3>
              <img
                className="act"
            ...
            <div className="catItem drama" id="drama" onClick={toggle}>
              <h3 className="title" id="drama" onClick={toggle}>
                drama
              </h3>
              <img
                className="act"
            ...
            <div className="catItem romance" id="romance" onClick={toggle}>
              <h3 className="title" id="romance" onClick={toggle}>
                romance
              </h3>
              <img
                className="act"
            ...
            <div className="catItem thriller" id="thriller" onClick={toggle}>
              <h3 className="title" id="thriller" onClick={toggle}>
                thriller
              </h3>
              <img
                className="act"
            ...
            <div className="catItem western" id="western" onClick={toggle}>
              <h3 className="title" id="western" onClick={toggle}>
                western
              </h3>
              <img
                className="act"
            ...
            <div className="catItem horror" id="horror" onClick={toggle}>
              <h3 className="title" id="horror" onClick={toggle}>
                horror
              </h3>
              <img
                className="act"
            ...
            <div className="catItem fantasy" id="fantasy" onClick={toggle}>
              <h3 className="title" id="fantasy" onClick={toggle}>
                fantasy
              </h3>
              <img
                className="act"
            ...
            <div className="catItem music" id="music" onClick={toggle}>
              <h3 className="title" id="music" onClick={toggle}>
                music
              </h3>
              <img
                className="act"
            ...
            <div className="catItem fiction" id="fiction" onClick={toggle}>
              <h3 className="title" id="fiction" onClick={toggle}>
                fiction
              </h3>
              <img
                className="act"
